...
public final class Ts3Crypt {
    ...
    public static SecureChannelParameters cryptoInit(byte[] alpha, byte[] beta, byte[] omega,
    ...
    public static SecureChannelParameters cryptoInit2(byte[] license, byte[] alpha,
        ...
        SecureChannelParameters parameters =
