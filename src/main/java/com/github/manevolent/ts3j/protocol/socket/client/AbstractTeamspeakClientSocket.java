...
public abstract class AbstractTeamspeakClientSocket
    ...
    public Packet readPacketIntl(NetworkPacket networkPacket) throws IOException {
    ...
    public Packet readPacket(NetworkPacket networkPacket) throws
            IOException,
            TimeoutException {
        long timeout;
        ...
        PacketBodyType ackType = packet.getHeader()
                .getType()
                .getAcknolwedgedBy();
